...
<head>
    ...
    <link rel="stylesheet" href="libs/cubeportfolio/css/cubeportfolio.min.css">
        ...
        <div class="row sectionIntro">
            ...
            <div class="col-xs-12 col-sm-9">
                <p class="shortAbout">Hi, ik ben <span>Casper Streefkerk</span> en doe niets liever dan toffe digitale
                    producten ontwerpen, websites bouwen, muziek luisteren, sporten en energiek leven!
                </p>
            </div>
        </div>
        <div class="row">
...
<!--        </div>-->
    ...
    <div id="work" class="container workContent">
<!--        <div class="row">-->
<!--            <div class="col-xs-12 titleRow">-->
<!--                <h2><span class="sectionTitle">WORK</span><span class="colorPoint">.</span></h2>-->
<!--            </div>-->
<!--        </div>-->
        <div class="row">
            <div class="col-xs-12">
                <div id="js-filters-masonry" class="cbp-l-filters-alignRight portfolioFilters">
                ...
                <div id="js-grid-masonry" class="cbp">
                    <div class="cbp-item identity">
                        <a href="http://google.com" class="cbp-caption" data-title="Easy Note<br>by Cosmin Capitanu">
...
<footer class="footer">
    <div class="container">
        <div class="col-sm-4 col-xs-12 copyrightContent">
            <p>Let's make great things together!</p>
        </div>

        <div class="col-sm-8 col-xs-12 socialsContent">
